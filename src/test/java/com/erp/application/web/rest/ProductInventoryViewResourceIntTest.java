...
public class ProductInventoryViewResourceIntTest {
    ...
    @Autowired
    private ProductInventoryViewMapper productInventoryViewMapper;

    @Autowired
    private ProductInventoryViewService productInventoryViewService;

    /**
     * This repository is mocked in the com.erp.application.repository.search test package.
     *
     * @see com.erp.application.repository.search.ProductInventoryViewSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void setup() {
        ...
        final ProductInventoryViewResource productInventoryViewResource = new ProductInventoryViewResource(productInventoryViewService);
    ...
    public void createProductInventoryView() throws Exception {
        ...
        ProductInventoryViewDTO productInventoryViewDTO = productInventoryViewMapper.toDto(productInventoryView);
        restProductInventoryViewMockMvc.perform(post("/api/product-inventory-views")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(productInventoryViewDTO)))
    ...
    public void updateProductInventoryView() throws Exception {
        ...
        ProductInventoryViewDTO productInventoryViewDTO = productInventoryViewMapper.toDto(updatedProductInventoryView);
    ...
    public void dtoEqualsVerifier() throws Exception {
        TestUtil.equalsVerifier(ProductInventoryViewDTO.class);
        ProductInventoryViewDTO productInventoryViewDTO1 = new ProductInventoryViewDTO();
        productInventoryViewDTO1.setId(1L);
        ProductInventoryViewDTO productInventoryViewDTO2 = new ProductInventoryViewDTO();
        assertThat(productInventoryViewDTO1).isNotEqualTo(productInventoryViewDTO2);
        productInventoryViewDTO2.setId(productInventoryViewDTO1.getId());
        assertThat(productInventoryViewDTO1).isEqualTo(productInventoryViewDTO2);
        productInventoryViewDTO2.setId(2L);
        assertThat(productInventoryViewDTO1).isNotEqualTo(productInventoryViewDTO2);
        productInventoryViewDTO1.setId(null);
        assertThat(productInventoryViewDTO1).isNotEqualTo(productInventoryViewDTO2);
    }
    ...
    public void testEntityFromId() {
        assertThat(productInventoryViewMapper.fromId(42L).getId()).isEqualTo(42);
        assertThat(productInventoryViewMapper.fromId(null)).isNull();
    }
}
