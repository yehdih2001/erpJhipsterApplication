...
public class ProductCountResourceIntTest {
     ...
     *
     * @see com.erp.application.repository.search.ProductCountSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void setup() {
        ...
        final ProductCountResource productCountResource = new ProductCountResource(productCountService);
    ...
    public void createProductCount() throws Exception {
        ...
        ProductCountDTO productCountDTO = productCountMapper.toDto(productCount);
        restProductCountMockMvc.perform(post("/api/product-counts")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(productCountDTO)))
    ...
    public void updateProductCount() throws Exception {
        ...
        updatedProductCount
            ...
            .sold(UPDATED_SOLD);
        ProductCountDTO productCountDTO = productCountMapper.toDto(updatedProductCount);
    ...
    public void dtoEqualsVerifier() throws Exception {
        TestUtil.equalsVerifier(ProductCountDTO.class);
        ProductCountDTO productCountDTO1 = new ProductCountDTO();
        productCountDTO1.setId(1L);
        ProductCountDTO productCountDTO2 = new ProductCountDTO();
        assertThat(productCountDTO1).isNotEqualTo(productCountDTO2);
        productCountDTO2.setId(productCountDTO1.getId());
        assertThat(productCountDTO1).isEqualTo(productCountDTO2);
        productCountDTO2.setId(2L);
        assertThat(productCountDTO1).isNotEqualTo(productCountDTO2);
        productCountDTO1.setId(null);
        assertThat(productCountDTO1).isNotEqualTo(productCountDTO2);
    }
    ...
    public void testEntityFromId() {
        assertThat(productCountMapper.fromId(42L).getId()).isEqualTo(42);
        assertThat(productCountMapper.fromId(null)).isNull();
    }
}
