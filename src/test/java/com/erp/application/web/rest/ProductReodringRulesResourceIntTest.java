...
public class ProductReodringRulesResourceIntTest {
    ...
    @Autowired
    private ProductReodringRulesMapper productReodringRulesMapper;

    @Autowired
    private ProductReodringRulesService productReodringRulesService;

    /**
     * This repository is mocked in the com.erp.application.repository.search test package.
     *
     * @see com.erp.application.repository.search.ProductReodringRulesSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void setup() {
        ...
        final ProductReodringRulesResource productReodringRulesResource = new ProductReodringRulesResource(productReodringRulesService);
    ...
    public void createProductReodringRules() throws Exception {
        ...
        ProductReodringRulesDTO productReodringRulesDTO = productReodringRulesMapper.toDto(productReodringRules);
        restProductReodringRulesMockMvc.perform(post("/api/product-reodring-rules")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(productReodringRulesDTO)))
    ...
    public void updateProductReodringRules() throws Exception {
        ...
        ProductReodringRulesDTO productReodringRulesDTO = productReodringRulesMapper.toDto(updatedProductReodringRules);
    ...
    public void dtoEqualsVerifier() throws Exception {
        TestUtil.equalsVerifier(ProductReodringRulesDTO.class);
        ProductReodringRulesDTO productReodringRulesDTO1 = new ProductReodringRulesDTO();
        productReodringRulesDTO1.setId(1L);
        ProductReodringRulesDTO productReodringRulesDTO2 = new ProductReodringRulesDTO();
        assertThat(productReodringRulesDTO1).isNotEqualTo(productReodringRulesDTO2);
        productReodringRulesDTO2.setId(productReodringRulesDTO1.getId());
        assertThat(productReodringRulesDTO1).isEqualTo(productReodringRulesDTO2);
        productReodringRulesDTO2.setId(2L);
        assertThat(productReodringRulesDTO1).isNotEqualTo(productReodringRulesDTO2);
        productReodringRulesDTO1.setId(null);
        assertThat(productReodringRulesDTO1).isNotEqualTo(productReodringRulesDTO2);
    }
    ...
    public void testEntityFromId() {
        assertThat(productReodringRulesMapper.fromId(42L).getId()).isEqualTo(42);
        assertThat(productReodringRulesMapper.fromId(null)).isNull();
    }
}
