...
public class CompagnyResourceIntTest {
     ...
     *
     * @see com.erp.application.repository.search.CompagnySearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void setup() {
        ...
        final CompagnyResource compagnyResource = new CompagnyResource(compagnyService);
    ...
    public void createCompagny() throws Exception {
        ...
        // Create the Compagny
        CompagnyDTO compagnyDTO = compagnyMapper.toDto(compagny);
        restCompagnyMockMvc.perform(post("/api/compagnies")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(compagnyDTO)))
    ...
    public void updateCompagny() throws Exception {
        ...
        CompagnyDTO compagnyDTO = compagnyMapper.toDto(updatedCompagny);
    ...
    public void searchCompagny() throws Exception {
        // Initialize the database
        compagnyRepository.saveAndFlush(compagny);
        when(mockCompagnySearchRepository.search(queryStringQuery("id:" + compagny.getId()), PageRequest.of(0, 20)))
            .thenReturn(new PageImpl<>(Collections.singletonList(compagny), PageRequest.of(0, 1), 1));
        // Search the compagny
    ...
    public void dtoEqualsVerifier() throws Exception {
        TestUtil.equalsVerifier(CompagnyDTO.class);
        CompagnyDTO compagnyDTO1 = new CompagnyDTO();
        compagnyDTO1.setId(1L);
        CompagnyDTO compagnyDTO2 = new CompagnyDTO();
        assertThat(compagnyDTO1).isNotEqualTo(compagnyDTO2);
        compagnyDTO2.setId(compagnyDTO1.getId());
        assertThat(compagnyDTO1).isEqualTo(compagnyDTO2);
        compagnyDTO2.setId(2L);
        assertThat(compagnyDTO1).isNotEqualTo(compagnyDTO2);
        compagnyDTO1.setId(null);
        assertThat(compagnyDTO1).isNotEqualTo(compagnyDTO2);
    }
    ...
    public void testEntityFromId() {
        assertThat(compagnyMapper.fromId(42L).getId()).isEqualTo(42);
        assertThat(compagnyMapper.fromId(null)).isNull();
    }
}
